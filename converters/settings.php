...
?>
		...
		<tr class="punhead">
			<td class="punhead" colspan="2"><b>PunBB Migration Tool - Settings</b></td>
		</tr>
		...
		<tr>
			<td class="puncon1right">PunBB database:&nbsp</td>
			<td class="puncon2"><?php echo $db_name; ?></td>
		</tr>

		<tr>
			<td class="puncon1right">PunBB prefix:&nbsp</td>
			<td class="puncon2"><?php echo $db_prefix; ?></td>
		</tr>
		<tr>
			<td class="puncon1right">Hostname/user:&nbsp</td>
			<td class="puncon2">
				<input type="radio" name="sameordiff" onClick="duffusers('same');" value="same" <?php if($type == 1) echo 'checked'; ?>>Same host/user
				<input type="radio" name="sameordiff" onClick="duffusers('diff');" value="diff" <?php if($type == 2) echo 'checked'; ?>>Different host/user
			</td>
		</tr>
...
?>
				<input type="text" name="diff_db" style="width: 150px;" class="form" value="<?php if(isset($_SESSION['php_db'])) echo $_SESSION['php_db_clean']; ?>">
			</td>
...
<?php
		...
		{
			$selected = (isset($_SESSION['php_db_clean']) && $ob[0] == $_SESSION['php_db_clean']) ? ' selected' : '';
...
?>
		...
		<tr>
			...
			<td class="puncon2" style="white-space: nowrap">
				<b>Warning:</b> <span style="color: red">ALL PunBB tables will be deleted!</span><br>
