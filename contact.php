		...
		<form id="contact" method="post" action="contact.php">
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						Veuillez ecrire vos information et votre message ici. Si vous avez de commentaires, problèmes ou autre avec le forum, merci de nous les faire parvenir.<br />
