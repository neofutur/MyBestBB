...
<?php endif; ?>					<fieldset>
						...
						<div class="infldset">
							...
							<table summary="group title" class="aligntop" cellspacing="0">
								<tr>
...
else if (isset($_POST['set_default_group']))
{
	...
	$group_id = intval($_POST['default_group']);
        if ($group_id < 4) // punbb 1.2.14 update  WAS //	if ($group_id < 1)
		message($lang_common['Bad request']);
			...
			<form id="groups" method="post" action="admin_groups.php?action=foo">
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="base new group on :" class="aligntop" cellspacing="0">
								<tr>
...
?>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="default group" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<table summary="edit group" cellspacing="0">
<?php
