...
$mod_title      = 'Image Verification';
$mod_version    = '1.0.3';
$release_date   = '03-19-05';
...
function install()
{
	...
	$db->query('INSERT INTO '.$db->prefix."config (conf_name, conf_value) VALUES('o_regs_verify_image', '0')") or error('Unable to insert into table '.$db->prefix.'config. Please check your configuration and try again. <a href="JavaScript: history.go(-1)">Go back</a>.');
