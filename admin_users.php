...
<div id="users1" class="blocktable">
	...
	<div class="box">
		<div class="inbox">
			<table summary="user data" cellspacing="0">
			<thead>
				<tr>
...
<div id="users2" class="blocktable">
	...
	<div class="box">
		<div class="inbox">
			<table summary="user_data" cellspacing="0">
			<thead>
				<tr>
...
else if (isset($_POST['find_user']))
{
	...
	while (list($key, $input) = @each($form))
	{
		 ...
		 if ($input != '' && in_array($key, array('username', 'email', 'title', 'realname', 'url', 'jabber', 'icq', 'msn', 'aim', 'yahoo', 'location', 'signature', 'admin_note'))) // punbb 1.2.14 update  WAS //		if ($input != '')
	...
	if ($user_group != 'all')
		$conditions[] = 'u.group_id='.intval($user_group); // punbb 1.2.14 update
// WAS		$conditions[] = 'u.group_id='.$db->escape($user_group);
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<table summary="user data"  class="aligntop" cellspacing="0">
								<tr>
