...
//$pun_user = $db->query('SELECT u.id, u.group_id, g.g_id, g.g_read_chatbox, g.g_post_chatbox, g_title_chatbox FROM '.$db->prefix.'users AS u, '.$db->prefix.'groups AS g ON g.g_id=u.id ORDER BY g.g_id DESC LIMIT '.$pun_config['cb_max_msg']) or error('Unable to fetch messages', __FILE__, __LINE__, $db->error());
//var_dump($pun_user);
...
if ($pun_user['g_read_board'] == '0' || $pun_user['g_read_chatbox'] == '0')
...
?>
    ...
    <div id="scrollbox" style="overflow:auto;height:150px;">
