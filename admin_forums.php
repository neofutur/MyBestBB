			...
			<form id="edit_forum" method="post" action="admin_forums.php?edit_forum=<?php echo $forum_id ?>">
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="forum list" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							...
							<table summary="permissions" id="forumperms" cellspacing="0">
							<thead>
								<tr>
									<th class="atcl">&nbsp;</th>
									<th>Read forum</th>
			...
			<form method="post" action="admin_forums.php?action=adddel">
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="add forum" class="aligntop" cellspacing="0">
								<tr>
...
$result = $db->query('SELECT c.id AS cid, c.cat_name, f.id AS fid, f.forum_name, f.disp_position, f.parent_forum_id FROM '.$db->prefix.'categories AS c INNER JOIN '.$db->prefix.'forums AS f ON c.id=f.cat_id WHERE f.parent_forum_id = 0 ORDER BY c.disp_position, c.id, f.disp_position') or error('Unable to fetch category/forum list', __FILE__, __LINE__, $db->error());
...
?>
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="category" cellspacing="0">
<?php
