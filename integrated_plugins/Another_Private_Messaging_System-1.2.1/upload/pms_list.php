...
<div class="block">
	...
	<div class="box">
		<div class="inbox">
			<ul class="conl">
				<li id="pms_inbox"><a href="pms_list.php?box=0"><?php echo ($box == 0 ? '<strong>'.$lang_pms['Inbox'].'</strong>' : $lang_pms['Inbox']); ?></a></li>
				<li id="pms_sentbox"><a href="pms_list.php?box=1"><?php echo ($box == 1 ? '<strong>'. $lang_pms['Outbox'].'</strong>' : $lang_pms['Outbox']); ?></a></li>
