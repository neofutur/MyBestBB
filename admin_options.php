...
if (isset($_POST['form_sent']))
{
	...
	$form['smtps_tls'] = intval($form['smtps_tls']);
			...
			<form method="post" action="admin_options.php?action=foo">
				...
				<input type="hidden" name="form_sent" value="1" />
					<fieldset>
						...
						<div class="infldset">
							<table summary="Board title" class="aligntop" cellspacing="0">
								<tr>
...
?>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="time" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="version" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Quick Post" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Report Method" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Use Avatars" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Admin Email" class="aligntop" cellspacing="0">
								<tr>
								...
								<tr>
									<th scope="row">SMTP(S) server address and port</th>
									<td>
								...
								<tr>
									<th scope="row">Use SMTPS / TLS </th>
									<td>
										<input type="radio" name="form[smtps_tls]" value="1"<?php if ($pun_config['o_smtps_tls'] == '1') echo ' checked="checked"' ?> />&nbsp;<strong>Yes</strong>&nbsp;&nbsp;&nbsp;<input type="radio" name="form[smtps_tls]" value="0"<?php if ($pun_config['o_smtps_tls'] == '0') echo ' checked="checked"' ?> />&nbsp;<strong>No</strong>
								<span>Do you want to use SMTPS ( secure SMTP with TLS encryption )this option is necessary if you want to use a secure SMTP like the one gmail / google hosted provides; if you check this option you ll have to include the port in the SMTP server adress
								</span>
									</td>
								</tr>
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Allow new registrations" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Display announcement" class="aligntop" cellspacing="0">
								<tr>
				...
				<div class="inform">
					<fieldset>
						...
						<div class="infldset">
							<table summary="Maintenance" class="aligntop" cellspacing="0">
								<tr>
