...
//$form = '<form id="post" method="post" name="post" action="post.php?action=post&amp;tid='.$tid.'" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">'; // wad before attachments

$form = '<form id="post" method="post" name="post" enctype="multipart/form-data" action="post.php?action=post&amp;tid='.$tid.'" onsubmit="this.submit.disabled=true;if(process_form(this)){return true;}else{this.submit.disabled=false;return false;}">'; //Attachment Mod has added enctype="multipart/form-data"
...
//$form = '<form id="post" method="post" name="post" action="post.php?action=post&amp;fid='.$fid.'" onsubmit="return process_form(this)">'; // was before attachments
$form = '<form id="post" method="post" name="post" enctype="multipart/form-data" action="post.php?action=post&amp;fid='.$fid.'" onsubmit="return process_form(this)">';             //Attachment Mod has added enctype="multipart/form-data"
...
<!-- mod modern_bbcode -->
<?php endif; require PUN_ROOT.'mod_modern_bbcode.php'; ?><label>
