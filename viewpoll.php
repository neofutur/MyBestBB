...
// Load the viewtopic.php language file and topic rating
...
<div class="blockform">
    ...
    if ((!$pun_user['is_guest']) && (!in_array($pun_user['id'], $voters)) && ($cur_topic['closed'] == '0')) {
		...
		<form id="post" method="post" action="vote.php">
			<div class="inform">
				<div class="rbox" style="margin-left: auto !important; margin-right: auto !important; width: 800px !important; text-align: center;">
		...
		<?php
            if ($ptype == 1) {
              ...
              <tr>
                <td style="width: 10; border: 0;"><input name="vote" <?php if (!$firstcheck) { echo 'checked="checked"'; $firstcheck = true; }; ?> type="radio" value="<?php echo $key ?>" /></td>
                <td style="border: 0; width: auto;"><span><?php echo pun_htmlspecialchars($value); ?></span></td>
              </tr>
		<?php     } 
            } elseif ($ptype == 2) {
		            while (list($key, $value) = each($options)) { ?>
              <tr>
                <td style="width: 10; border: 0;"><input name="options[<?php echo $key ?>]" type="checkbox" value="1" /></td>
                <td style="border: 0; width: auto;"><span><?php echo pun_htmlspecialchars($value); ?></span></td>
              </tr>
		<?php     } 
            } elseif ($ptype == 3) {
				        while (list($key, $value) = each($options)) { ?>
              <tr>
                <td style="width: auto; border: 0;"><?php echo pun_htmlspecialchars($value); ?></td>
                <td style="border: 0; width: auto;"><input name="options[<?php echo $key ?>]" checked="checked" type="radio" value="yes" /> <?php echo $cur_topic['yes']; ?></td>
                <td style="border: 0; width: auto;"><input name="options[<?php echo $key ?>]" type="radio" value="no" /> <?php echo $cur_topic['no']; ?></td>
              </tr>
		<?php     } 
      ...
      <div class="rbox" style="margin-left: auto !important; margin-right: auto !important; width: 800px !important; text-align: center;">
		...
		if ($ptype == 1 || $ptype == 2) 
		{
          ...
          <tr>
            <td style="width: auto; border: 0;"><?php echo pun_htmlspecialchars($value); ?></td>
            <td style="border: 0; width: 45%; text-align: left !important;"><h2 style="width: <?php if (isset($votes[$key])) echo $percent_int; else echo "0"; ?>%; font-size: 1px; height: 2px; margin-bottom: 3px"></h2></td>
            <td style="border: 0; width: auto;"> <?php if (isset($votes[$key])) echo $percent_int . "% - " . $votes[$key]; else echo "0% - 0"; ?></td>
          </tr>
			<?php
			}
			else if ($ptype == 3) 
          ...
          <tr>
            ...
            <td style="border: 0; width: 22%; text-align: left !important;"><h2 style="width: <?php if (isset($votes[$key])) echo $yes_percent; else echo "0"; ?>%; font-size: 1px; height: 2px; margin-bottom: 3px"></h2></td>
            ...
            <td style="border: 0; width: 22%; text-align: left !important;"><h2 style="width: <?php if (isset($votes[$key])) echo $no_percent; else echo "0"; ?>%; font-size: 1px; height: 2px; margin-bottom: 3px"></h2></td>
            <td style="border: 0; width: auto;">
				<?php 
					if (isset($votes[$key]['no'])) 
        ...
        <tr>
          <td colspan="7" style="width: auto; border: 0;">Total: <?php echo $total; ?></td>
        </tr>
          <?php } ?>
      </table>
			</div>
