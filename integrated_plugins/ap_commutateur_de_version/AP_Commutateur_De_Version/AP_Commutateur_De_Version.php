...
if (isset($_POST['update_version']))
{
	if (trim($_POST['to_version']) == '')
		message('Vous devez saisir un numéro de version.');
	...
	<div id="exampleplugin" class="blockform">
		...
		<div class="box">
			<form method="post" action="<?php echo $_SERVER['REQUEST_URI'] ?>&amp;foo=bar">
				<div class="inform">
					<fieldset>
						<legend>Saisissez un numéro de version et appuyez la "Mettre à jour"</legend>
						<div class="infldset">
							<p>Ce plugin vous permet de mettre à jour la chaîne de caractère de version de PunBB.</p>
							<table class="aligntop" cellspacing="0">
								<tr>
									<th scope="row">Nouvelle version</th>
									<td>
										<input type="text" name="to_version" size="8" tabindex="1" />
										<span>La nouvelle chaîne de caractère de version.</span>
									</td>
								</tr>
							</table>
							<div class="fsetsubmit"><input type="submit" name="update_version" value="Mettre à jour" tabindex="2" /></div>
						</div>
					</fieldset>
				</div>
			</form>
