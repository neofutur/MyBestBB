	...
	<div class="box">
		<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>?foo=bar">
			...
			<div class="inform">
				...
				<p><strong>Important instructions:</strong> Before pressing the install button, you must be sure that the /attach/ folder on your website is writable by apache ( use chown, chmod ) or the attachment mod wont work
				<br /><input type="hidden" name="full_basename" size="80" value="<?php echo dirname($_SERVER['SCRIPT_FILENAME']); ?>/attach/"></p>
