...
// punbb is dead, punbb has been sold :
	$fp = @fopen('http://punbb.informer.com/latest_version', 'r');
	//$fp = @fopen('http://www.punbb.org/latest_version', 'r'); // was before
...
//  security update from punbb 1.2.22
...
//		message('A new version of PunBB has been released. You can download the latest version at <a href="http://www.punbb.org/">PunBB.org</a>.'); //was before
}
