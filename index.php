...
$res_ssforum = $db->query($sql, true) or error('Impossible to find subforums list, you need to install the mods , see the file <b>INSTALL_mybestBB.txt</b> for instructions <br /> Impossible de trouver la liste des sous forums, merci de lire le fichier INSTALL_mybestBB_fr.txt pour plus de precisions', __FILE__, __LINE__, $db->error());
