<?php
	...
	echo "\n<br>Converting posts: $start...<br>"; flush();

	// Fetch posts info
	$result = $fdb->query('SELECT * FROM '.$_SESSION['php'].'messages WHERE message_id>'.$start.' ORDER BY message_id LIMIT '.$_SESSION['limit']) or myerror("Unable to get posts", __FILE__, __LINE__, $fdb->error());
	$last_id = -1;
