...
if (isset($_POST['delete']))
{
	...
	if ($is_topic_post)
	{
                attach_delete_thread($cur_post['tid']); // Attachment Mod , delete the attachments in the whole thread (orphan check is checked in this function)		// Delete the topic and all of it's posts
